  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] font-sans pb-24">
      ...
      <div className="px-5 space-y-4">
        {loading && <div className="flex justify-center py-10"><Loader2 className="animate-spin text-slate-400" size={32} /></div>}
        ...
        {redemptions.map((r) => (
          <div key={r._id} onClick={() => navigate(`/redemptions/${r._id}`, { state: { redemption: r } })} className="w-full text-left bg-white rounded-[24px] shadow-sm border border-gray-100 p-5 flex justify-between items-center transition hover:shadow-md active:scale-[0.98] cursor-pointer">
