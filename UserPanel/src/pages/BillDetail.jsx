...
export default function BillDetail() {
  ...
  if (!b) { navigate("/bills", { replace: true }); return null; }
    ...
    <div className="min-h-screen bg-[#F5F7FA] font-sans">
      ...
      <div className="p-5 space-y-4 pb-10">
        ...
        {b.billImage && (
          <div className="bg-white rounded-2xl p-4 border border-gray-100">
            ...
            <img src={b.billImage} alt="Bill" className="w-full rounded-xl object-cover cursor-zoom-in active:scale-95 transition-transform" onClick={() => setFullScreen(true)} />
            <a href={b.billImage} target="_blank" rel="noopener noreferrer" className="mt-3 flex items-center justify-center gap-2 bg-[#F5F7FA] border border-gray-200 text-gray-700 font-bold py-3 rounded-xl text-sm w-full active:scale-95 transition">
      ...
      {fullScreen && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4" onClick={() => setFullScreen(false)}>
          <img src={b.billImage} alt="Full" className="w-full h-full object-contain" />
